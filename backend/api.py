...
@login_required
def api_clubs():
    return jsonify(get_all_clubs(DB_PATH))
...
def api_efficiency():
    club_id, team, date_from, date_to = _get_filter_params()
    return jsonify(get_player_efficiency(DB_PATH, team=team, date_from=date_from, date_to=date_to, club_id=club_id))
...
def api_goal_efficiency():
    club_id, team, date_from, date_to = _get_filter_params()
    return jsonify(get_goal_efficiency_per_game(DB_PATH, team=team, date_from=date_from, date_to=date_to, club_id=club_id))
...
def api_player_names():
    club_id, team, date_from, date_to = _get_filter_params()
    return jsonify(get_all_player_names(DB_PATH, team=team, date_from=date_from, date_to=date_to, club_id=club_id))
